		...
		switch (format){
			...
			default:
				...
				switch (format){
					...
					case FORMAT_R16I:     headerDX10.dxgiFormat = 59; break;
					case FORMAT_R16UI:    headerDX10.dxgiFormat = 57; break;
...
bool Image::saveTGA(const char *fileName){
	...
	TGAHeader header = {
		0x00,
		((format == FORMAT_I8)? 1U : 0U),
		((format == FORMAT_I8)? 1U : 2U),
		0x0000,
		((format == FORMAT_I8)? 256U : 0U),
		((format == FORMAT_I8)? 24U  : 0U),
		0x0000,
		0x0000,
		uint16(width),
		uint16(height),
